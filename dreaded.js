...
client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/e188a1cedd4a2a401f7ea.jpg' }, caption: cap, fileLength: "9999999999"}, { quoted: m })
} else if (menu === 'LINK') {
client.sendMessage(m.chat, {
                        text: cap,
                        contextInfo: {
...
client.sendMessage(from, buttonMessage, { quoted: m }) 
 ...
 break 
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `*_𝐑𝐚𝐢𝐝𝐞𝐫 𝐂𝐨𝐧𝐯𝐞𝐫𝐭𝐞𝐫 🦄_*`}, { quoted: m }) 
...
case "movie": 
 ...
 break;
        ...
        case "gpt": case "g": 
            ...
            if (!text) return reply("Hello am 𝐑𝐀𝐈𝐃𝐄𝐑 an Ai developed by 𝐔𝐧𝐫𝐮𝐥𝐲, how can I help you today?");
